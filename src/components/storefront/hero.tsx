...
export function Hero({ hero }: { hero: HeroSettings }) {
  ...
  if (!activeSlide) {
    return (
      <section className="border-b border-[#eadfcf] bg-[#f6efe3]">
        <div className="container-shell py-4 md:py-6">
          <div className="relative aspect-[12/7] overflow-hidden rounded-[2rem] border border-[#eadfcf] bg-[linear-gradient(135deg,#fffaf2,#efe6d7)] shadow-[0_20px_50px_rgba(26,20,12,0.08)] sm:aspect-[16/8]">
  ...
  return (
    <section className="border-b border-[#eadfcf] bg-[#f6efe3]">
      <div className="container-shell py-4 md:py-6">
        <div className="relative aspect-[12/7] overflow-hidden rounded-[2rem] border border-[#eadfcf] bg-[#efe8dc] shadow-[0_20px_50px_rgba(26,20,12,0.08)] sm:aspect-[16/8]">
