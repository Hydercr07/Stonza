...
export default async function ManagedPageRoute({
      ...
      <section className="container-shell page-section">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-5">
            ...
            <h1 className="page-title text-[#171717]">{page.heroHeading}</h1>
  ...
  return (
    <section className="container-shell page-section">
      <div className="rounded-[2rem] border border-black/8 bg-white p-6 sm:p-8 shadow-[0_18px_42px_rgba(17,24,39,0.06)]">
        <h1 className="page-title text-[#171717]">{page.heroHeading}</h1>
